...
import { dehydratedPowderProducts } from "../../data/otherProductRanges";
import heroImage from "../../assets/products-images/DehydratedPowders/Hero.png";
import aboutImage from "../../assets/products-images/DehydratedPowders/about.png";
import whyChooseImage from "../../assets/products-images/DehydratedPowders/whychoose.png";
      ...
      <section className="pb-[70px] max-md:pb-12">
        <div className={`${containerClass} max-w-[1480px] text-center`}>
          <h2 className="mx-auto max-w-[650px] text-[clamp(34px,4vw,52px)] font-bold leading-[1.18] text-[#1b3156]">
            Explore Our <span className="text-[#30c8bb]">Dehydrated Powders</span>
          </h2>
          <p className="mt-4 text-[15px] font-semibold text-[#8b929b]">Shelf-stable onion, garlic, beetroot, and ginger powders for food and wellness applications.</p>
          <ProductRangeGrid products={dehydratedPowderProducts} categorySlug="dehydrated-powders" />
        </div>
      </section>
