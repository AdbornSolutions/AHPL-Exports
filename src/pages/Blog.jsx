...
const Blog = () => {
  ...
  const posts = [
    ...
    },
    {
      ...
      to: '/blog/b2b-sourcing-in-india-guide-for-international-buyers',
    },
    {
      ...
      to: '/blog/benefits-of-working-with-indian-merchant-exporter',
    },
    {
      ...
      to: '/blog/metal-wall-decor-manufacturer',
    },
    {
