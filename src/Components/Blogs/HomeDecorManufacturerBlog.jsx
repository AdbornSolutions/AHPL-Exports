...
const HomeDecorManufacturerBlog = () => {
  useEffect(() => {
    ...
    meta?.setAttribute('content', 'Discover what makes a Home Decor Manufacturer India a preferred choice for global buyers. Learn how AHPL Exports delivers premium handcrafted décor, private label solutions, and wholesale home décor products worldwide.')
    return () => {
